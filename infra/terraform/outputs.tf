...
output "ssh_command" {
  ...
  description = "SSH command to connect to the EC2 instance (using DNS name). Copy/paste ready."
}
...
output "ssh_command_ip" {
  ...
  description = "SSH command to connect to the EC2 instance (using IP address). Copy/paste ready."
}
